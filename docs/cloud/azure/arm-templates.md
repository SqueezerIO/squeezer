---
title: Microsoft Azure - Resource Manager templates
---
...
Use different templates on different evnironments , eg:

`PROJECT_DIR/armTemplates/dev/azuredeploy.json`

`PROJECT_DIR/armTemplates/prod/azuredeploy.json`
