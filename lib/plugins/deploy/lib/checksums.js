  ...
  get() {
    return new Promise((resolve, reject) => {
      ...
      if (key) {
        ...
        this.sqz.cli.log.warn('By using an empty Squeezer deployment key you can\'t take the advantage of using smart deployments , this means that all the microservices will be deployed even the ones where code dint\'t changed');
        resolve();
      }
    });
  }
